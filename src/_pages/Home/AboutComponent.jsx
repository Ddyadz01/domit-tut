      ...
      <CenterContent>
        ...
        <div className={styles.home_page__about_cards}>
          <div className={styles.home_page__about_cards__card}>
            ...
            <TextComponent text={'Работаем с юридическими  и физическими лицами'} />
          </div>
          <div className={styles.home_page__about_cards__card}>
            <img src="./icons/home_about/icon_benefits_2.png" alt="" />
            <TextComponent
              text={'Бесплатный подбор, честные консультации и открытость к сотрудничеству'}
            />
          </div>
          <div className={styles.home_page__about_cards__card}>
          ...
          <div className={styles.home_page__about_cards__card}>
            ...
            <TextComponent text={'Средний рейтинг компании 4,5 из 5 (Avito, Google, Отзовик)'} />
          </div>
        </div>
      </CenterContent>
    </div>
